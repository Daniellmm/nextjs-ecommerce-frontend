export default function ReviewCard() {
    return (
        <div className="p-4 border border-gray-300 rounded-3xl flex flex-col gap-2 items-start">
            <div className="flex ">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-5 text-orange-300">
